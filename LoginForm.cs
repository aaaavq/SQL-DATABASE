...
namespace coffee
{
...

    {
        ...
        public void InitializeCombobox()
        {
            ...
            cboRole.Items.Add("Warehouse Manager");
            cboRole.Items.Add("Sale1");
        ...
        private void RedirectPage(string selectedRole, int employeeID, bool IsChangePassword)
        {
            if(IsChangePassword)
            {
                if(selectedRole != null)
                {
                    ...
                    {
                        Admin admin = new Admin(employeeID, selectedRole);
                        this.Hide();
                        admin.Show();
                    }
                    ...
                    else if(selectedRole == "Sale1")
                    {
                        SaleForm1 saleForm1 = new SaleForm1(selectedRole, employeeID);
                        this.Hide();
                        saleForm1.Show();
                    }
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            if (isValid)
            {
                ...
                string query = "SELECT EmployeeId, PasswordChanged FROM Employees WHERE Username = @username " +
